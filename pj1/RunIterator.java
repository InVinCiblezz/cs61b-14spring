...
public class RunIterator implements Iterator {
  ...
  public boolean hasNext() {
    ...
    //System.out.println(list.next(list.back()) != null);
    //System.out.println(list.next(current) != null);
    return current != null;
  }
  ...
  public int[] next() {
    ...
    int[] ans = (int[]) current.item;
    current = dList.next(current);
    return ans;
  }

  public DListNode getCurrent() {
    return dList.prev(current);
  }
